...
export const Main = () => {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-4 pb-16 gap-8 font-[family-name:var(--font-geist-sans)] sm:p-20 sm:pb-20 sm:gap-16">
