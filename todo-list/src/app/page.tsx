  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start sm:flex-row">
        <h1 className="text-5xl font-bold w-full max-w-xs">Todo List</h1>
        <div className="flex flex-col gap-2">
          <form className="flex items-center">
            ...
            <button
              type="submit"
              className="bg-[#230c38] text-[#ffffff] font-semibold py-3 px-6 rounded-r-lg transition-colors duration-300"
            >
              Add
            </button>
          </form>
